...
#define FAIL false
#define assert_param(_x) assert(_x)
...
#define SX126X_STATUS_MODE_STDBY_RC                   2  //  6     4     current chip mode: STDBY_RC
#define SX126X_STATUS_MODE_STDBY_XOSC                 3  //  6     4                        STDBY_XOSC
#define SX126X_STATUS_MODE_FS                         4  //  6     4                        FS
#define SX126X_STATUS_MODE_RX                         5  //  6     4                        RX
#define SX126X_STATUS_MODE_TX                         6  //  6     4                        TX
#define SX126X_STATUS_DATA_AVAILABLE                  2  //  3     1     command status: packet received and data can be retrieved
#define SX126X_STATUS_CMD_TIMEOUT                     3  //  3     1                     SPI command timed out
#define SX126X_STATUS_CMD_INVALID                     4  //  3     1                     invalid SPI command
#define SX126X_STATUS_CMD_FAILED                      5  //  3     1                     SPI command failed to execute
#define SX126X_STATUS_TX_DONE                         6  //  3     1                     packet transmission done
...
public:
     ...
     */
    bool SetPayload( uint8_t *payload, uint8_t size );
     ...
     */
    virtual bool WriteCommand( RadioCommands_t opcode, uint8_t *buffer, uint8_t size ) = 0;
     ...
     * \param [in]  size          Command parameters byte array size
     */
    virtual bool ReadCommand( RadioCommands_t opcode, uint8_t *buffer, uint8_t size ) = 0;
     ...
     */
    virtual bool WriteRegister( uint16_t address, uint8_t *buffer, uint16_t size ) = 0;
     ...
     */
    virtual bool ReadRegister( uint16_t address, uint8_t *buffer, uint16_t size ) = 0;
     ...
     */
    virtual bool WriteBuffer( uint8_t offset, uint8_t *buffer, uint8_t size ) = 0;
